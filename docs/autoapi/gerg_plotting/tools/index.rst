...
.. py:class:: Data
   ...
   .. py:method:: get_vars(have_values: bool | None = None) -> list
...
.. py:function:: data_from_csv(filename: str, mapped_variables: dict | None = None, custom_vars: str | list[str] | None = None, **kwargs)
...
.. py:function:: data_from_df(df: pandas.DataFrame, mapped_variables: dict | None = None, custom_vars: str | list[str] | None = None, **kwargs)
...
.. py:function:: data_from_ds(ds: xarray.Dataset, interp_glider: bool = False, mapped_variables: dict | None = None, custom_vars: str | list[str] | None = None, **kwargs)
...
.. py:function:: data_from_netcdf(filename: str, mapped_variables: dict | None = None, interp_glider: bool = False, custom_vars: str | list[str] | None = None, **kwargs)
